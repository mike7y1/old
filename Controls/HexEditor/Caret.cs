...
// Type: InvokedServer.Controls.HexEditor.Caret
...
namespace InvokedServer.Controls.HexEditor
{
	public class Caret
	{
		...
		{
			get => this._endIndex < this._startIndex ? this._endIndex : this._startIndex;
		}
		...
		public int SelectionLength
		{
			get
			{
				return this._endIndex < this._startIndex ? this._startIndex - this._endIndex : this._endIndex - this._startIndex;
			}
		}
		...
		public Caret(InvokedServer.Controls.HexEditor.HexEditor editor)
		{
			this._editor = editor;
