...
// Type: InvokedServer.Controls.HexEditor.HexViewHandler
...
namespace InvokedServer.Controls.HexEditor
{
	public class HexViewHandler
	{
		...
		public int MaxWidth
		{
			get => this._recHexValue.X + this._recHexValue.Width * this._editor.BytesPerLine;
		}

		public HexViewHandler(InvokedServer.Controls.HexEditor.HexEditor editor)
		{
			this._editor = editor;
