...
// Type: InvokedServer.Controls.HexEditor.HexEditor
...
namespace InvokedServer.Controls.HexEditor
{
	public class HexEditor : Control
	{
		...
		private InvokedServer.Controls.HexEditor.HexEditor.CaseStyle _lineCountCaseStyle = InvokedServer.Controls.HexEditor.HexEditor.CaseStyle.UpperCase;
		private InvokedServer.Controls.HexEditor.HexEditor.CaseStyle _hexViewCaseStyle = InvokedServer.Controls.HexEditor.HexEditor.CaseStyle.UpperCase;
		...
		[DefaultValue(InvokedServer.Controls.HexEditor.HexEditor.CaseStyle.UpperCase)]
		[Category("Hex")]
		[Description("Property for the case type to use on the line counter.")]
		public InvokedServer.Controls.HexEditor.HexEditor.CaseStyle LineCountCaseStyle
		{
			...
			set
			{
				...
				this._lineCountCaps = this._lineCountCaseStyle != InvokedServer.Controls.HexEditor.HexEditor.CaseStyle.LowerCase ? "X" : "x";
				this.Invalidate();
			}
		}
		...
		public InvokedServer.Controls.HexEditor.HexEditor.CaseStyle HexViewCaseStyle
		{
			...
			set
			{
				...
				if (this._hexViewCaseStyle == InvokedServer.Controls.HexEditor.HexEditor.CaseStyle.LowerCase)
		...
		private void UpdateRectanglePositioning()
		{
			...
			int width = local3.Width;
			margin = this.Margin;
			int right = margin.Right;
			local3.Width = width - right;
			ref Rectangle local4 = ref this._recContent;
			int height = local4.Height;
			margin = this.Margin;
			int bottom = margin.Bottom;
			local4.Height = height - bottom;
			...
			if (!this.VScrollBarHidden)
			{
				...
				int num1 = this._recContent.X + this._recContent.Width;
				margin = this.Margin;
				int left2 = margin.Left;
				int num2 = num1 - left2;
				vScrollBar1.Left = num2;
				VScrollBar vScrollBar2 = this._vScrollBar;
				int y2 = this._recContent.Y;
				margin = this.Margin;
				int top2 = margin.Top;
				int num3 = y2 - top2;
				vScrollBar2.Top = num3;
